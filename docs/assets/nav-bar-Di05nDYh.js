(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&l(i)}).observe(document,{childList:!0,subtree:!0});function d(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function l(e){if(e.ep)return;e.ep=!0;const t=d(e);fetch(e.href,t)}})();class E extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){const c=this.shadowRoot,d=document.createElement("style");d.textContent=`
        ...
        `;const l=document.createElement("header"),e=document.createElement("div");e.className="wrap";const t=document.createElement("a");t.className="brand",t.href="index.html",t.textContent="JL • Portfolio";const i=document.createElement("nav");i.setAttribute("aria-label","Primary");const f=[{href:"index.html",file:"index.html",text:"Home"},{href:"projects.html",file:"projects.html",text:"Projects"},{href:"about.html",file:"about.html",text:"About"},{href:"fun.html",file:"fun.html",text:"Fun"},{href:"contact.html",file:"contact.html",text:"Contact"}],x=f.map(({href:r,file:s,text:h})=>{const a=document.createElement("a");return a.href=r,a.dataset.file=s,a.textContent=h,a});i.append(...x);const o=document.createElement("button");o.className="burger",o.setAttribute("aria-label","Menu"),o.setAttribute("aria-expanded","false");const b=document.createElement("span");b.className="lines",o.appendChild(b),e.append(t,i,o),l.appendChild(e);const n=document.createElement("div");n.className="sheet",n.setAttribute("aria-hidden","true");const p=document.createElement("div");p.className="panel",p.setAttribute("role","menu");const m=f.map(({href:r,file:s,text:h})=>{const a=document.createElement("a");return a.href=r,a.dataset.file=s,a.textContent=h,a.setAttribute("role","menuitem"),a});p.append(...m),n.appendChild(p),c.append(d,l,n);const v=()=>{const r=location.pathname.split("/").pop();return r&&r.length?r:"index.html"};(()=>{const r=v();[...x,...m].forEach(s=>{s.classList.toggle("active",s.dataset.file===r)})})();const u=()=>{n.classList.remove("show"),o.setAttribute("aria-expanded","false")},y=()=>{n.classList.add("show"),o.setAttribute("aria-expanded","true")};o.addEventListener("click",()=>{n.classList.contains("show")?u():y()}),n.addEventListener("click",r=>{r.target===n&&u()}),m.forEach(r=>r.addEventListener("click",u)),this.addEventListener("keydown",r=>{r.key==="Escape"&&u()})}}customElements.define("app-nav",E);
